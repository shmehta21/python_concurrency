from example_threads import ThumbnailMakerService
...
def test_thumbnail_maker():
    tns = ThumbnailMakerService()
    print(f'Home directory is -- {tns.home_dir}')
    print(f'Input directory is -- {tns.input_dir}')
    print(f'Output directory is -- {tns.output_dir}')
    tns.make_thumbnails(IMG_URLS)
